import{e as t,T as e,K as o,r as i,b as s,c as r,n as a,s as n,x as l,d as c,L as p,N as d,O as h,P as u,H as m,I as _,k as v,Q as g,C as w,S as y}from"./index-enlvTT7f.js";import{c as f}from"./c.BC9A2Bx_.js";import{g as b}from"./c.cMXAl4je.js";import"./c.C2ITiWVK.js";import{o as $,c as S}from"./c.CUXlds-B.js";import{m as P,s as x,b as k}from"./c.L7vpoWlH.js";import{o as C}from"./c.CkOdsLqq.js";class j{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class E{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const H=t=>!o(t)&&"function"==typeof t.then,W=1073741823;const I=t(class extends f{constructor(){super(...arguments),this._$C_t=W,this._$Cwt=[],this._$Cq=new j(this),this._$CK=new E}render(...t){var o;return null!==(o=t.find((t=>!H(t))))&&void 0!==o?o:e}update(t,o){const i=this._$Cwt;let s=i.length;this._$Cwt=o;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<o.length&&!(t>this._$C_t);t++){const e=o[t];if(!H(e))return this._$C_t=t,e;t<s&&e===i[t]||(this._$C_t=W,s=0,Promise.resolve(e).then((async t=>{for(;a.get();)await a.get();const o=r.deref();if(void 0!==o){const i=o._$Cwt.indexOf(e);i>-1&&i<o._$C_t&&(o._$C_t=i,o.setValue(t))}})))}return e}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),D=(t,e)=>{import("./c.GS2M9WVR.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)},T=async(t,e)=>{import("./c.-hPUjJFm.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?$((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=S(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},A={info:u,warning:h,error:d,success:p};let B=class extends n{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return l`
      <div
  ...
  `,s([r()],B.prototype,"title",void 0),s([r({attribute:"alert-type"})],B.prototype,"alertType",void 0),s([r({type:Boolean})],B.prototype,"rtl",void 0),B=s([a("esphome-alert")],B);const q=(t,e)=>{import("./c.Dh-yGr-m.js");const o=document.createElement("esphome-download-type-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)};let U=class extends n{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._shouldDownloadFactory=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=l`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
        ...
        <mwc-button
          ...
          label="Cancel"
        ></mwc-button>
      `;else if("pick_server_port"===this._state)t="Pick Server Port",e=void 0===this._ports?this._renderProgress("Loading serial devices"):l`
              ${this._isPico?l`
                  ...
                  `:""}
              ${0===this._ports.length?this._renderMessage("👀",l`
              ...
              ></mwc-button>
            `;else if("download_instructions"===this._state){let o;const i=I(this._compileConfiguration,l`<a download disabled href="#">Download project</a>
          preparing&nbsp;download…
          <mwc-circular-progress
            density="-8"
            indeterminate
          ></mwc-circular-progress>`);this._isPico?(t="Install ESPHome via the USB drive",o=l`
          <div>
        ...
        `):(t="Install ESPHome via the browser",o=l`
          <div>
      ...
      <div class="center">
        <div>
          <mwc-circular-progress
            ...
            density="8"
          ></mwc-circular-progress>
          ${void 0!==e?l`<div class="progress-pct">${e}%</div>`:""}
        </div>
        ${t}
      </div>
    `}_renderMessage(t,e,o){return l`
      <div class="center">
...
//# sourceMappingURL=c.D5jbhA3X.js.map
